...
echo "#------------------------------------------------------------#"
echo "mysql-server mysql-server/root_password password MYSQLPASS123" | sudo debconf-set-selections
echo "mysql-server mysql-server/root_password_again password MYSQLPASS123" | sudo debconf-set-selections
